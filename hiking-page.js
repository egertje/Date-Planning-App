...
let service;
let photoElement;
const nameElement = document.querySelector(".hiking-name");
...
function initMap() {
    ...
    photoElement = document.getElementById('hiking-photo');
...
function showMarkerInfo(placeResult, marker, status) {
    if (status == google.maps.places.PlacesServiceStatus.OK) {
        ...
        showHikingInfo(placeResult);
    } 
}

function showHikingInfo(placeResult) {
    ...
    if (placeResult.photos) {
        ...
        photo.classList.add('hiking-img');
