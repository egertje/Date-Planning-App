...
let service;
let photoElement;
const nameElement = document.querySelector(".gaming-name");
...
function initMap() {
    ...
    photoElement = document.getElementById('gaming-photo');
...
function getGaming(position) {
    let request = {
        location: position,
        rankBy: google.maps.places.RankBy.DISTANCE,
        keyword: 'arcade mini golf bowling'
    };
...
function showMarkerInfo(placeResult, marker, status) {
    if (status == google.maps.places.PlacesServiceStatus.OK) {
        ...
        showGamingInfo(placeResult);
    } 
}

function showGamingInfo(placeResult) {
    ...
    if (placeResult.photos) {
        ...
        photo.classList.add('gaming-img');
